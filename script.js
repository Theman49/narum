...
alert("click everywhere to see fireworks ☺")
// let myCake = document.getElementById("myCake");

// function showMe(){
//     if(myCake.style.display == "none"){
...
let containerCake = document.getElementById("containerCake");


// append cake
function includeHTML() {
  $("#containerCake").load("child.html");
  
  setTimeout(() => {
    scrollTo(0, containerCake.offsetTop-20);
  },1000);
